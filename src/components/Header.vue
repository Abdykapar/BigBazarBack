        ...
        <div class="row align-items-center">
          <div class="col-lg-4 sm-mx-none">
            <div class="d-flex align-items-center">
              <a href="help-center.html" class="text-general"><span>ПОМОЩЬ И ПОДДЕРЖКА</span></a>
            </div>
          </div>
          <div class="col-lg-8 d-flex">
            <ul class="top-links d-flex ms-auto align-items-center">
              ...
              <!-- <li><a href="#">США / ДОЛЛАР США / АНГЛИЙСКИЙ</a></li> -->
              <li><a href="/wish-list"><i class="flaticon-like flat-mini me-1 text-primary"></i> СПИСОК ЖЕЛАНИЙ</a></li>
              <li class="my-account-dropdown">
                <a href="my-account.html" class="has-dropdown"><i class="flaticon-user-3 flat-mini text-primary me-1"></i>МОЙ АККАУНТ</a>
                <ul class="my-account-popup">
                  <li v-if="!userProfile.token"><a href="/login"><span class="menu-item-text">Войти</span></a></li>
                  <li v-if="!userProfile.token"><a href="/register"><span class="menu-item-text">Регистрация</span></a></li>
                  <li v-else><button @click="logout"><span class="menu-item-text">Выйти</span></button></li>
                  <li><a href="/cart"><span class="menu-item-text">ПРОВЕРИТЬ</span></a></li>
                  <li><a href="wishlist.html"><span class="menu-item-text">СПИСОК ЖЕЛАНИЙ</span></a></li>
                </ul>
              </li>
            </ul>
          </div>
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto">
                  <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="/">ДОМ</a>
                  </li>
                  <li class="nav-item dropdown mega-dropdown">
                    <a class="nav-link dropdown-toggle" href="#">МАГАЗИН</a>
                  </li>
                  <li class="nav-item dropdown">
            ...
            <div class="d-flex align-items-center justify-content-end h-100">
              <div class="product-search-one flex-grow-1 global-search touch-screen-view">
                <form class="form-inline search-pill-shape" action="#" method="post">
                  <input type="text" class="form-control search-field" name="search" placeholder="Я делаю покупки для">
              ...
              <div class="search-view my-0 d-xl-none">
              ...
              <!-- <div class="refresh-view my-0 ml-30">
          ...
          <div class="col-xxl-3 col-xl-4 col-lg-3 col-6 order-lg-3">
            <div class="d-flex align-items-center justify-content-end h-100 md-py-10">
              <div class="sign-in position-relative font-general my-account-dropdown">
                <a v-if="!userProfile.token" href="my-account.html" class="has-dropdown d-flex align-items-center text-dark text-decoration-none" title="My Account">
                  <i class="flaticon-user-3 flat-small me-1"></i>
                </a>
                <ul class="my-account-popup">
                  <li v-if="!userProfile.token"><a href="my-account.html"><span class="menu-item-text">My Account</span></a></li>
