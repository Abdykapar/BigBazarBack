                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            <nav class="navbar navbar-expand-lg nav-dark nav-primary-hover">
                                <a class="navbar-brand" href="/"><img class="nav-logo" src="/assets/images/logo/17.png" alt="Image not found !"></a>
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    <ul class="navbar-nav ms-xxl-5">
                                        ...
                                        <li class="nav-item dropdown">
                                            <a class="nav-link dropdown-toggle" href="blog-grid-left-sidebar.html">БЛОГ</a>
                                        </li>
                        ...
                        <div class="col-lg-5">
                            <div class="d-flex h-100 justify-content-end">
                                ...
                                <div class="d-flex align-items-center justify-content-end h-100 ms-5">
                                    <div class="sign-in my-account-dropdown position-relative">
                                        <a href="/wish-list" class="has-dropdown d-flex align-items-center text-white text-decoration-none">
                                            <i @click="$router.push('/wish-list')" class="flaticon-like flat-small text-dark"></i>
                                        </a>
                                    </div>
                                    <div class="search-view my-0 d-xxl-none ml-10">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-xxl-3 col-xl-4 col-lg-3 col-6 order-lg-3">
                            <div class="d-flex align-items-center justify-content-end h-100 md-py-10">
                                ...
                                <div class="wishlist-view my-0 ml-10">
                                ...
                                <div class="refresh-view my-0 ml-10">
